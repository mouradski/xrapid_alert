...
@Repository
public interface ExchangeToExchangePaymentRepository extends
        CrudRepository<ExchangeToExchangePayment, Integer>,
        JpaSpecificationExecutor<ExchangeToExchangePayment> {
    ...
    Double getVolumeBetween(String source, String destination, long startTimestamp,
                            long endTimestamp);
    ...
    Double getVolumeBySourceAndDestinationBetween(String source, String destination,
    ...
    Double getVolumeBySourceFiatAndDestinationFiatBetween(String source, String destination,
                                                          long startTimestamp, long endTimestamp);
