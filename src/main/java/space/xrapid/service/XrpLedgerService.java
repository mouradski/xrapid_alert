...
public class XrpLedgerService {
  ...
  public List<Payment> fetchOdlCandidatePayments(OffsetDateTime startOffset,
      OffsetDateTime endOffset, boolean odlCandidateOnly) {
  ...
  private Predicate<Payment> filterPayments(boolean odlCandidateOnly) {
    return p -> !odlCandidateOnly || (Exchange.byAddress(p.getSource()) != null
        && Exchange.byAddress(p.getDestination()) != null);
  }
